package cn.cnicg.jpa_entity_generator.config;
...
public class CodeGeneratorConfig implements Serializable {
    ...
    private String dtoPackageName = "cn.cnicg.dto";
    private String serviceIntfPackageName = "cn.cnicg.service";
    private String serviceImplPackageName = "cn.cnicg.service.impl";
